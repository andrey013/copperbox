...
--------------------------------------------------------------------------------
-- |
-- Module      :  Graphics.OTFont.PrimitiveDatatypes
...
--
-- Primitive datatypes - often alias over standard types
--
--------------------------------------------------------------------------------

module Graphics.SFont.PrimitiveDatatypes where
...
-- Font files are parsed as an array - the parse monad moves the index 
-- around rather than consumes (i.e. discards) input. 
