...
ppBMPbody :: Word32 -> Word32 -> BMPbody -> Doc
ppBMPbody _ _ UnrecognizedFormat  = text "Unrecognized Format"
ppBMPbody w h (Mono grid)         = ppMono w h grid
             

ppMono :: Word32 -> Word32 -> ImageData -> Doc
ppMono w h = text . quickAsciiHack w h
