...
rgbToYCbCr :: PaletteColour -> YCbCrColour
rgbToYCbCr (PaletteColour rv gv bv) = YCbCrColour y cb cr
  where
...
yCbCrToRgb :: YCbCrColour -> PaletteColour
yCbCrToRgb (YCbCrColour y cb cr) = PaletteColour rv gv bv
  where
