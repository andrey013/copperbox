...
module HNotate.Base.EventTree where

import HNotate.Base.Utils (applyi)
...
-- Event trees
newtype System evt = System { getSystem :: [EventTree evt] }
  deriving Show
...
system :: [EventTree evt] -> System evt
system = System
...
a >#< b         = EventTree $ (getEventTree a) >< (getEventTree b)
