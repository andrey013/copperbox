...
--------------------------------------------------------------------------------
-- |
-- Module      :  Sound.Slac.Supercollider.SynthDef.Internal.ParseMonad
...
module Sound.Slac.Supercollider.SynthDef.Internal.ParserMonad
  (
...
-- | Note - this parser relies on @fromIntegral@ to coerce a 
-- Word16.
-- 
int16be :: ParserM Int16
int16be = liftM fromIntegral word16be
...
ieee754Single :: ParserM Double
ieee754Single = unpackSingle <$> word8 <*> word8 <*> word8 <*> word8
