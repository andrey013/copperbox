...
-- | Extract a printable instrument name from a GMInst.
--
-- This is @show@ on the constructor with underscore replaced by
-- a space.
--
instrumentName :: GMInst -> String
instrumentName = map replaceUnderscore . show
  where
    replaceUnderscore '_' = ' '
    replaceUnderscore z   = z
