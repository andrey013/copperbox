...
-- Event trees
newtype System evt = System { getSystem :: Seq (EventTree evt) }
  deriving Show
...
instance Monoid (System evt) where
  ...
  mappend a b = System $ (getSystem a) >< (getSystem b)
...
system :: Seq (EventTree evt) -> System evt
system = System

systemL :: [EventTree evt] -> System evt
systemL = System . fromList

system1 :: EventTree evt -> System evt
system1 = System . singleton 
