...
pic1 = uniformScale 2 $ frame $ 
    [ fillEllipse blue 10 10 dzeroPt
    , fillEllipse red 10 10 (dP2 40 40)
    , ztextlabel "Wumpus!" (dP2 40 20)
    , square red 5 (dP2 50 10)  
    ]


square :: PtSize u => RGBi -> u -> Point2 u -> Primitive
